...
const classReps = [
	...
	},
	{
		...
		description:
			"Luôn nhiệt tình trong công tác vệ sinh lớp và các hoạt động lao động (ờm maybe)",
	},
];
...
const faqItems = [
	...
	},
	{
		...
		answer: "Lớp mình đã tổ chức nhiều hoạt động như: văn nghệ chào mừng 20/11, dã ngoại cuối năm, hoạt động từ thiện vào dịp Tết, và tham gia tích cực các cuộc thi của trường.",
	},
];
